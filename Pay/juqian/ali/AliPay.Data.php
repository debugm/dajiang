	...
	**/
	public function ToXml()
	{
		if(!is_array($this->values) 
			|| count($this->values) <= 0)
		{
    		throw new AliPayException("数组数据异常！");
    	}
	...
	{	
		if(!$xml){
			throw new AliPayException("xml数据异常！");
		}
        //将XML转为array
        //禁止引用外部xml实体
 ...
 *
 */
class AliPayResults extends  AliPayDataBase
{
	/**
	 * 
	 * 检测签名
	...
	public function CheckSign()
	{
		...
		//fix异常
		if(!$this->IsSignSet()){
			throw new AliPayException("签名错误！");
		}
 ...
 *
 */
class AliPayNotifyReply extends  AliPayDataBase
{
	/**
	 * 设置接口版本
	 * @param string $value
 ...
 *
 */
class AliPayUnifiedOrder extends AliPayDataBase
{
 ...
 *
 */
class AliPayWapOrder extends AliPayDataBase
{
 ...
 *
 */
class AliPayCloseOrder extends AliPayDataBase
{
	/**
	 * 设置接口版本
	 * @param string $value
 ...
 *
 */
class AliPayOrderQuery extends AliPayDataBase
{
	/**
	 * 设置接口版本
	 * @param string $value
 ...
 *
 */
class AliPayRefundOrder extends AliPayDataBase
{
    /**
     * 设置接口版本
     * @param string $value
