...
<div class="row">
 <div class="row">
  ...
  <form role="form" id="loginpasswordform" class="form-horizontal m-t" method="post" action="<?php echo U("Account/editpaypassword");?>">
    ...
    <button type="button" id="loading-example-btn" data-loading-text="正在处理..." class="btn btn-primary" data-target="#myModal" onclick="javascript:paypasswordsubmit(this)" ajaxurl="<?php echo U("Account/verifypaypassword");?>">确认修改</button>&nbsp;&nbsp;&nbsp;&nbsp;
  </form>
</div>
