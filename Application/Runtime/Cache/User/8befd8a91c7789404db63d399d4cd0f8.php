...
<script src="<?php echo ($siteurl); ?>Public/Admin/js/tklist.js" /></script>
<script src="<?php echo ($siteurl); ?>Public/User/js/js.js" /></script>
...
<div style="margin-top: 20px;">
  <form class="form-inline" role="form">
    ...
    <div class="form-group">
      <input type="text"  id="tjdate_ks" name="tjdate_ks"  class="laydate-icon zy-searchstr" onclick="laydate()" style="font-size: 25px; height: 30px; width:160px;" value="<?php echo ($_GET['tjdate_ks']); ?>">
    </div>
    <div class="form-group" style="margin-left:20px;">
     至
    </div>
    <div class="form-group" style="margin-left:20px;">
     <input type="text"  id="tjdate_js" name="tjdate_js"  class="laydate-icon zy-searchstr" onclick="laydate()" style="font-size: 25px; height: 30px; width:160px;" value="<?php echo ($_GET['tjdate_js']); ?>">
    </div>
    <div class="form-group" style="margin-left:40px;">
     打款时间：
    </div>
    <div class="form-group">
      <input type="text"  id="cgdate_ks" name="cgdate_ks"  class="laydate-icon zy-searchstr" onclick="laydate()" style="font-size: 25px; height: 30px; width:160px;" value="<?php echo ($_GET['cgdate_ks']); ?>">
    </div>
    <div class="form-group" style="margin-left:20px;">
     至
    </div>
    <div class="form-group" style="margin-left:20px;">
     <input type="text"  id="cgdate_js" name="cgdate_js"  class="laydate-icon zy-searchstr" onclick="laydate()" style="font-size: 25px; height: 30px; width:160px;" value="<?php echo ($_GET['cgdate_js']); ?>">
    </div>
...
<div class="table-responsive" style="margin:0px auto; margin-top:10px;">
  <table class="table table-bordered table-hover table-condensed table-responsive">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td style="text-align:center; color:#060"><b><?php echo del0($vo["tkmoney"]);?></b> 元</td>
          <td style="text-align:center; color:#666"><b><?php echo del0($vo["sxfmoney"]);?></b> 元</td>
          <td style="text-align:center; color:#C00"><b><?php echo del0($vo["money"]);?></b> 元</td>
          <td style="text-align:center;"><?php echo ($vo["bankname"]); ?></td>
          <td style="text-align:center;"><?php echo ($vo["bankfenname"]); ?> <br> <?php echo ($vo["bankzhiname"]); ?></td>
          <td style="text-align:center;"><?php echo ($vo["bankfullname"]); ?></td>
          <td style="text-align:center;"><?php echo ($vo["banknumber"]); ?></td>
          <td style="text-align:center;"><?php echo ($vo["sheng"]); ?> <?php echo ($vo["shi"]); ?></td>
          ...
          <?php switch($vo["status"]): case "0": ?><span style="color:#F00;">未处理</span><?php break;?>
            ...
            <?php case "3": ?><span style="color:#060;">已撤销</span><?php break;?>
            <?php default: endswitch;?>
          </td>
        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
      <tr>
        <td colspan="17" style="text-align:center;"><div class="pagex"> <?php echo ($_page); ?></div></td>
      </tr>
    </tbody>
  </table>
</div>
