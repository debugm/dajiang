  ...
  <div class="sidebar-collapse">
    <ul class="nav" id="side-menu">
	  ...
	  <li> <a href="#"> <i class="fa fa-book"></i> <span class="nav-label">内容管理</span> <span class="fa arrow"></span> </a>
        <ul class="nav nav-second-level">
		   <li><a href="<?php echo U("Content/articleclassadd");?>" class="J_menuItem">添加栏目</a></li>
		   <li><a href="<?php echo U("Content/articleclasslist");?>" class="J_menuItem">栏目管理</a></li>
		   <li><a href="<?php echo U("Content/articleadd");?>" class="J_menuItem">添加文章</a></li>
		   <li><a href="<?php echo U("Content/articlelist");?>" class="J_menuItem">文章管理</a></li>
        </ul>
      </li>
      <li> <a href="#"> <i class="fa fa-user"></i> <span class="nav-label">用户管理</span> <span class="fa arrow"></span> </a>
        <ul class="nav nav-second-level">
		   ...
		   <li><a href="<?php echo U("User/useraccountupload");?>" class="J_menuItem">用户通道账户上传</a></li>
		   <li><a href="<?php echo U("User/subiduploadview");?>" class="J_menuItem">子商户信息上传</a></li>
		   <li><a href="<?php echo U("User/userskuploadview");?>" class="J_menuItem">商户收款信息上传</a></li>
		   <li><a href="<?php echo U("User/invitecode");?>" class="J_menuItem"><?php echo L("ADMIN_YHGL_YAOQINGMAGUANLI");?></a></li>
		   <li><a href="<?php echo U("User/llrecharge");?>" class="J_menuItem">流量充值</a></li>
		   <li><a href="<?php echo U("User/setwallet");?>" class="J_menuItem">流量设置</a></li>
		   <li><a href="<?php echo U("User/subidcontrol");?>" class="J_menuItem">子商户管理</a></li>
        </ul>
      </li>
      <li> <a href="#"> <i class="fa fa-bank"></i> <span class="nav-label">网关通道</span> <span class="fa arrow"></span> </a>
        <ul class="nav nav-second-level">
	  <li><a href="<?php echo U("Payaccess/managepayaccess");?>" class="J_menuItem">通道管理</a></li>
      <li><a href="<?php echo U("Payaccess/systembank");?>" class="J_menuItem">银行设置</a></li>
        </ul>
      </li>
        ...
        <ul class="nav nav-second-level">
			...
			<!--<li><a href="<?php echo U("Dealmanages/wxord");?>" class="J_menuItem">微信个人码交易统计</a> </li>
			<li><a href="<?php echo U("Dealmanages/wxdiaodan");?>" class="J_menuItem">微信个人码掉单统计</a> </li>-->
			<li><a href="<?php echo U("User/usertji");?>" class="J_menuItem">交易查询</a> </li>
			<li><a href="<?php echo U("User/tongdaotj");?>" class="J_menuItem">用户统计</a> </li>
			<!--
			<li><a href="<?php echo U("User/cglcx");?>" class="J_menuItem">子商户成功率查询</a> </li>
			<li><a href="<?php echo U("User/fstj");?>" class="J_menuItem">子商户分时成功率查询</a> </li>
			<li><a href="<?php echo U("User/daytj");?>" class="J_menuItem">每日商户成功率统计查询</a> </li>-->
			<!--<li><a href="<?php echo U("User/delxe");?>" class="J_menuItem">清空限额</a> </li>-->
		   <!--<li> <a href="<?php echo U("Dealmanages/zjbdjl");?>" class="J_menuItem">资金变动记录</a> </li>-->
 
        </ul>
      </li>
	      <li> <a href="#"> <i class="fa fa fa-cubes"></i> <span class="nav-label">提款设置</span> <span class="fa arrow"></span> </a>
        <ul class="nav nav-second-level">
			  <li> <a href="<?php echo U("Tikuan/tikuansz");?>" class="J_menuItem">提款设置</a> </li>
			    <li><a href="<?php echo U("Tikuan/tikuanlist");?>" class="J_menuItem">提款记录</a> </li>
			   <li> <a href="<?php echo U("Tikuan/wttikuanlist");?>" class="J_menuItem">委托提款记录</a> </li>
