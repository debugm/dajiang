...
<form class="form-horizontal" onsubmit="return editcheck();" action="<?php echo U("Payaccess/systembankeditedit");?>" enctype="multipart/form-data" method="post" >
<input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>">
  <div class="form-group">
    <label for="bankname" class="col-sm-3 control-label">银行名称：</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="bankname" name="bankname" value="<?php echo ($vo["bankname"]); ?>" placeholder="请输入银行名称" style="color:#39F; font-weight:bold;">
    </div>
  </div>
  <div class="form-group">
    <label for="bankcode" class="col-sm-3 control-label">银行编码：</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="bankcode" name="bankcode" value="<?php echo ($vo["bankcode"]); ?>" placeholder="请输入银行编码" style="color:#39F; font-weight:bold;">
    </div>
  </div>
  <div class="form-group">
    <label for="bankimages" class="col-sm-3 control-label">银行图标：</label>
     <div class="col-sm-6">
      <img src="/Uploads/bankimg/<?php echo ($vo["images"]); ?>" style="width:150px; height:33px;">
    </div>
