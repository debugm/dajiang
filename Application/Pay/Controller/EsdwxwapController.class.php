...
class EsdwxwapController extends PayController
{
    //商户私钥
    ...
    public function Pay(){
        ...
        $parameter = array(
            'PayName' => 'Esdwxwap', // 通道名称
            'zh_PayName' => 'Wxwap-ESD',
            'moneyratio' => 1, // 金额比例
            'tjurl' => '',
            'orderid' => $orderid,
            'body'=>$body,
...
$p = array(
                ...
                "service" => "YYKWXWAP", // yinlian .qq: HFQQWAP
...
header("Location:".$jump);
	...
	$p = file_get_contents("php://input");
        ...
        echo 'SUCCESS';	
        $this->EditMoney2($oid, 'Esdwxwap', 0,1);
    }
