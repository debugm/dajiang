...
class Zfbh5Controller extends PayController
{
    //商户私钥
    ...
    public function Pay(){
		...
		$url = "http://".$_SERVER['SERVER_NAME']."/Pay/juqian/do.php?amt=".$amt."&oid=".$oid."&nurl=".$nurl;
	...
	{
		$this->EditMoney2($val['out_trade_no'], 'Zfbh5', 0,1);	
	}
	echo "SUCCESS";
