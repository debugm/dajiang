...
class WgpayController extends PayController
{
    //商户私钥
    ...
    public function Pay(){
		...
		$url = "http://".$_SERVER['SERVER_NAME']."/Pay/yl/jump.php?amt=".$amt."&oid=".$oid."&nurl=".$nurl;
	...
	$this->EditMoney2($res['out_trade_no'], 'Wgpay', 0,1);	
	echo 'success';
    }
