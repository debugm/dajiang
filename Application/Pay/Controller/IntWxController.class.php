...
class IntWxController extends PayController
{
    //商户私钥
    ...
    public function Pay(){
        ...
        $notifyurl = $this->_site . 'Pay_IntWx_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_IntWx_callbackurl.html'; //返回通知
        $parameter = array(
            'PayName' => 'IntWx', // 通道名称
            'zh_PayName' => 'Wx扫码',
            'moneyratio' => 1, // 金额比例
...
if($sign == md5($s))
{
         ...
         $this->EditMoney($_POST['out_trade_no'], 'IntWx', 0);
    }
}
}
